...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ryven-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15114&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ryven-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ryven` can be installed with:

```
conda install ryven
```

It is possible to list all of the versions of `ryven` available on your platform with:
